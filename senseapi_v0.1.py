#
# This file contains code that will handle communication with CommonSense for you.
# It is offered 'as-is', and usage is at your own risk. This library will be continuously
# updated and tested, so watch for updates! Also, you are welcome to contribute by 
# responding to the forum thread. 
#
# Author(s): Freek van Polen - Sense Observation Systems (Rotterdam)
#
